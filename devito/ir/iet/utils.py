from devito.ir.iet import (Expression, Iteration, List,
                           FindSections, MergeOuterIterations)
from devito.symbolics import Eq
from devito.tools import as_tuple, flatten

__all__ = ['filter_iterations', 'copy_arrays', 'retrieve_iteration_tree',
           'is_foldable', 'compose_nodes']
